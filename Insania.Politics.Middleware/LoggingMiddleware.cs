...
namespace Insania.Politics.Middleware;
...
public class LoggingMiddleware(RequestDelegate next)
{
    ...
    public async Task Invoke(HttpContext context, LogsApiPoliticsContext contextDB)
    {
        ...
        LogApiPolitics log = new("system", true, method, type, request, null);
