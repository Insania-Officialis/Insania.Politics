...
namespace Insania.Politics.Services;
...
public class LoggingSL: ILoggingSL, IHostedService, IDisposable
{
    ...
    public LoggingSL(IServiceScopeFactory scopeFactory, ILogger<LoggingSL> logger)
    {
        ...
        //Создание канала
        _channel = Channel.CreateBounded<LogApiPolitics>(options);
    }
    #endregion
    ...
    /// </summary>
    private readonly Channel<LogApiPolitics> _channel;
    ...
    /// Пачка записей
    /// </summary>
    private readonly List<LogApiPolitics> _batch = [];
    ...
    public ValueTask QueueLogAsync(LogApiPolitics log) => _channel.Writer.WriteAsync(log, _cancellationTokenSource.Token);
    ...
    private async Task SaveBatchAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            LogsApiPoliticsContext context = scope.ServiceProvider.GetRequiredService<LogsApiPoliticsContext>();
