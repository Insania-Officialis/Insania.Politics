...
namespace Insania.Politics.Database.Migrations
{
    ...
    [Migration("20251029150250_Add_ParametersEntity_0")]
    partial class Add_ParametersEntity_0
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Insania.Politics.Entities.Area", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<long>("DomainId")
                        ...
                        .HasComment("Идентификатор владения");
                    ...
                    b.ToTable("c_areas", "insania_politics", t =>
                        {
            ...
            modelBuilder.Entity("Insania.Politics.Entities.Domain", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("c_domains", "insania_politics", t =>
                        {
                            t.HasComment("Владения");
                        });
                });

            modelBuilder.Entity("Insania.Politics.Entities.Locality", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("AreaId")
                        ...
                        .HasComment("Идентификатор области");
                    ...
                    b.Property<long>("LocalityLevelId")
                        .HasColumnType("bigint")
                        .HasColumnName("locality_level_id")
                        .HasComment("Идентификатор населённого пункта");
                    ...
                    b.HasIndex("LocalityLevelId");

                    b.ToTable("c_localities", "insania_politics", t =>
                        {
                            t.HasComment("Населённые пункты");
                        });
                });

            modelBuilder.Entity("Insania.Politics.Entities.LocalityLevel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("MaxSize")
                        ...
                        .HasComment("Максимальный размер");

                    b.Property<int>("MinSize")
                        .HasColumnType("integer")
                        .HasColumnName("min_size")
                        .HasComment("Минимальный размер");
                    ...
                    b.ToTable("c_localities_levels", "insania_politics", t =>
                        {
                            t.HasComment("Уровни населённых пунктов");
                        });
                });
            ...
            modelBuilder.Entity("Insania.Politics.Entities.ParameterPolitics", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("c_parameters", "insania_politics", t =>
                        {
                            t.HasComment("Параметры политики");
                        });
                });

            modelBuilder.Entity("Insania.Politics.Entities.Region", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("c_regions", "insania_politics", t =>
                        {
            ...
            modelBuilder.Entity("Insania.Politics.Entities.Area", b =>
                {
                    ...
                    b.HasOne("Insania.Politics.Entities.Domain", "DomainEntity")
                        .WithMany()
                        .HasForeignKey("DomainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Insania.Politics.Entities.Region", "RegionEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("Insania.Politics.Entities.Domain", b =>
                {
                    ...
                    b.HasOne("Insania.Politics.Entities.Domain", "ParentEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("Insania.Politics.Entities.Locality", b =>
                {
                    b.HasOne("Insania.Politics.Entities.Area", "AreaEntity")
                        .WithMany()
                        .HasForeignKey("AreaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Insania.Politics.Entities.LocalityLevel", "LocalityLevelEntity")
                        .WithMany()
                        .HasForeignKey("LocalityLevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AreaEntity");

                    b.Navigation("LocalityLevelEntity");
                });
            ...
            modelBuilder.Entity("Insania.Politics.Entities.Country", b =>
                {
                    b.Navigation("CountryCoordinates");
                });
