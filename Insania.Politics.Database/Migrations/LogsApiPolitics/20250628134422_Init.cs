    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.EnsureSchema(
                name: "insania_logs_api_politics");

            migrationBuilder.CreateTable(
                name: "r_logs_api_politics",
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_r_logs_api_politics", x => x.id);
                },
                comment: "Логи сервиса политики");

            migrationBuilder.CreateIndex(
                name: "IX_r_logs_api_politics_data_in",
                schema: "insania_logs_api_politics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_r_logs_api_politics_data_out",
                schema: "insania_logs_api_politics",
                table: "r_logs_api_politics",
                column: "data_out")
                .Annotation("Npgsql:IndexMethod", "gin");
